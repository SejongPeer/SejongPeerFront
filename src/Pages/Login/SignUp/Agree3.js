  ...
  return (
    <div className={agree.content}>
      ...
      <h3 style={{ textDecoration: 'underline' }}>
        제공하신 개인정보는 아래 수집 목적 이외의 용도로는 사용되지 않으며, 이용
        목적의 변경이 필요한 경우 정보주체에게 사전 동의 등 필요한 조치를 이행할
        예정입니다.
      </h3>
      <h3>개인정보 수집·이용 동의 및 필수항목의 고지</h3>
      <p>1. 개인정보의 수집 목적</p>
      <ul>
        <li>
          ◦ 회원제 서비스 이용 및 본인확인, 개인식별, 세종버디/혼밥탈출 매칭,
          세종스터디 커뮤니티 이용, 부정이용방지, 비인가 사용방지, 가입의사
          확인, 안내사항 전달 등을 목적으로 수집·이용 됨
        </li>
      </ul>
      <p>2. 수집하는 개인정보의 항목</p>
      <ul>
        <li>
          ◦ 필수항목: 이름, 성별, 아이디, 본인인증정보(세종대학교포털), 학번,
          학년, 닉네임, 학과, 카카오톡ID, 전화번호
        </li>
      </ul>
      <p>3. 관련법령에 의한 정보보유 사유</p>
      <ul>
        <li>
          ◦ 개인정보 보호법 등 관계법령의 규정에 의하여 보유가 필요한 경우
          세종피어는 법령에서 정한 기간동안 회원정보를 수집·처리합니다.
        </li>
      </ul>
      <p>4. 보유 및 이용 기간</p>
      <ul>
        <li> ◦ 보존기간: 회원 탈퇴 시 까지(또는 수집목적이 달성되는 시점)</li>
      </ul>

      <p>
        5. 동의를 거부할 권리가 있다는 사실 및 동의 거부에 따른 불이익의 내용
      </p>
      <ul>
        <li>
          ◦ 이용자는 개인정보 수집동의를 거부할 권리가 있습니다. 개인정보
          수집동의 거부 시 세종피어 일반회원으로 가입할 수 없습니다.
        </li>
      </ul>
      <h3>
        그 밖의 개인정보처리에 관한 사항은 홈페이지 하단의 '개인정보처리방침'을
        참고하시기 바랍니다.
      </h3>
    </div>
  );
