    ...
    return <div className={box.container}>
        <div className={box.auto}>
            <div className={box.inputText}>
                ...
                {agree ? <img src={check2} className={box.agree} alt='check2'/> : <img src={check} className={box.agree} alt='check'/>}
                </button>
            </div>
            ...
            <div className={box.flex}>
                ...
                {agree1 ? <img src={check2} className={box.agree} alt='check2'/> : <img src={check} className={box.agree} alt='check'/>}
                </button>
            </div>
            ...
            <div className={box.flex}>
                ...
                <button className={agree2border} onClick={agree2Handler}>
                    {agree2 ? <img src={check2} className={box.agree} alt='check2'/> : <img src={check} className={box.agree} alt='check'/>}
                </button>
            </div>

            <button onClick={goSignUp} className={sub.submitBtn}>동의 및 회원가입</button>
        </div>
    </div>;
};
