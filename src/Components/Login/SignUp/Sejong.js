...
const Sejong = () => {
    ...
    const isSejong = () => {
        axios.post('https://auth.imsejong.com/auth?method=ClassicSession HTTP/1.1', {
            "id": "19010656",
            "pw": "wkddbwls0204"
        })
    ...
    return <div className={style.container}>
        <div className={style.explain_box}>
            ...
            <p className={style.explain}>세종대학교 통합 로그인을 통해 인증합니다.</p>
      ...
      <a href="http://portal.sejong.ac.kr/" className={style.sejong}>http://portal.sejong.ac.kr/</a>
    </div>
}
