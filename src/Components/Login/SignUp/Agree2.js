...
const Agree2 = () => {
    return <div className={style.content}>
        ...
        본 약관은 세종피어가 운영하는 웹 사이트 (&lt;a href="http://www.sejongpeer.com"&gt;http://www.sejongpeer.com/&lt;/a&gt;)의 제반 서비스의 이용조건 및 절차에 관한 사항 및 기타 필요한 사항을 규정함을 목적으로 한다.</p>
        ...
        <p><strong>제 3 조 (약관의 공시 및 효력과 변경)</strong><br/>
        ...
        <p><strong>제 4 조 (약관 외 준칙)</strong><br/>
        ...
        <p><strong>제 2 장 이용계약</strong></p>

        <p><strong>제 5 조 (이용신청)</strong><br/>
        ①이용신청자가 회원가입 안내에서 본 약관과 개인정보 수집 및 이용약관에 동의하고 등록절차(회사의 소정 양식의 가입 신청서 작성)를 거쳐 '확인' 버튼을 누르면 이용신청을 할 수 있다.<br/>
        ...
        <p><strong>제 12 조 (서비스 이용의 제한)</strong><br/>
        ...
        <p><strong>제 13 조 (서비스 제공의 중지)</strong><br/>
        ...
        <p><strong>제 5 장 기타</strong></p>

        <p><strong>제 16 조 (면책 및 손해배상)</strong><br/>
        ...
        <p><strong>제 17 조 (개인신용정보 제공 및 활용에 대한 동의서)</strong><br/>
        ...
        <p><strong>제 19 조 (분쟁의 해결)</strong><br/>
