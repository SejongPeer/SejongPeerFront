...
const SignUp = () => {
    ...
    async function submitHandler(e){
        ...
        if(idValue === '' || pwdValue === '' || emailValue === '' || nameValue === '' || birthValue === '' || kakaoidValue === '' || phoneNumberValue === '' || genderValue === '' || majorValue === '' || studentNumberValue === ''){
            ...
            if(error === '가입완료 되었습니다.'){
                ...
                try {
                    const response = await fetch(process.env.REACT_APP_BACK_SERVER + '/user/join', {
                    method: 'POST',
                    ...
                    alert('제출에 실패했습니다. 다시 시도해주세요. (에러 내용: ' + err.message + ')');
                    e.preventDefault();
                }
            } else {
                alert(error);
    ...
    return <div className={style.container}>
        ...
        <div className={style.form}>
            ...
            onClick={submitHandler}>가입하기</button>
